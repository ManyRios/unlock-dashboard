...
//<Mainnet price={data} network={networkConfigs[1]}/>
//<Xdai price={data} network={networkConfigs[100]}/>
//<Polygon price={data} network={networkConfigs[137]}/>